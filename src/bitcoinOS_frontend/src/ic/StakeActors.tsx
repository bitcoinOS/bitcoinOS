...
import { canisterId, idlFactory } from "../../../declarations/stake/index";

import { ReactNode } from "react";
import { _SERVICE } from "../../../declarations/stake/stake.did";
...
export const usestakeBackend = createUseActorHook<_SERVICE>(actorContext);

export { type StakeRequest } from "../../../declarations/stake/stake.did";

export const StakeCanisterId = canisterId;

export default function StakeActors({ children }: { children: ReactNode }) {
